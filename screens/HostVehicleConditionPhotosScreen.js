...
import { FLOW_HOST_CHECK_IN, FLOW_HOST_CHECKOUT } from '../screens/PhotoShootScreen';
...
export default function HostVehicleConditionPhotosScreen({ navigation, route }) {
  ...
  const onContinue = useCallback(() => {
    navigation.navigate('PhotoShootScreen', {
      flow: checkoutFlow ? FLOW_HOST_CHECKOUT : FLOW_HOST_CHECK_IN,
      bookingId,
    });
