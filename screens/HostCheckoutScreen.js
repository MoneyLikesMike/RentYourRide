...
export default function HostCheckoutScreen({ navigation, route }) {
  ...
  const secondParagraphText = isDelivery
    ? `You'll coordinate pickup with ${guestName} at ${dropoffAddress}.`
    : `${guestName} will return the vehicle to ${pickupAddress}.`;
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <View style={styles.headlineRow}>
          ...
          <Text style={styles.headlineText}>{` to wrap up, ${hostNameForHeading}?`}</Text>
        </View>

        <View style={styles.copyColumn}>
          <Text style={styles.checkoutBlock}>
            <Text style={styles.checkoutMuted}>How was it? </Text>
            <Text style={styles.checkoutStrong}>{guestName}</Text>
            <Text style={styles.checkoutMuted}>'s trip ends at </Text>
            <Text style={styles.checkoutStrong}>{tripEndLine || '—'}</Text>
            <Text style={styles.checkoutMuted}> with your </Text>
            <Text style={styles.checkoutStrong}>{vehicleTitle}</Text>
          </Text>
