...
export default function GuestRentalAgreementSignScreen({ navigation, route }) {
  ...
  const damageNotes = isCheckoutFlow
    ? (booking?.guestCheckoutDamageNotes || booking?.rentalAgreementDamageNotes || '').trim() || 'None noted'
    : (booking?.guestCheckInDamageNotes || booking?.rentalAgreementDamageNotes || '').trim() || 'None noted';

  const guestConditionPhotos = useMemo(() => {
    if (isCheckoutFlow) {
      return Array.isArray(booking?.guestCheckoutConditionPhotos) ? booking.guestCheckoutConditionPhotos : [];
    }
    return Array.isArray(booking?.checkInConditionPhotos) ? booking.checkInConditionPhotos : [];
  }, [booking?.checkInConditionPhotos, booking?.guestCheckoutConditionPhotos, isCheckoutFlow]);
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        <Text style={styles.lead}>
          {isCheckoutFlow
            ? 'Review this summary of your rental agreement check-out. When you sign, your check-out is recorded.'
            : 'Review this summary of your rental agreement check-in. When you sign, your check-in is recorded.'}
        </Text>
        ...
        <PictureDocumentationPlaceholderGrid photos={guestConditionPhotos} />
        ...
        <Text style={styles.blockSectionTitle}>RENTER ACKNOWLEDGMENT & TERMS</Text>
        ...
        >
          ...
          <Text style={[styles.checkLabel, !termsReachedEnd && styles.checkLabelMuted]}>
            I have read this summary and the renter acknowledgment and terms above, and I confirm they
