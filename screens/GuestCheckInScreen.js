...
export default function GuestCheckInScreen({ navigation, route }) {
  ...
  const onLetsGo = () => {
    navigation.push('CheckInGuidelinesScreen', { bookingId: booking.id, role: 'guest' });
  };
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <Text style={styles.bodyBlock}>
          <Text style={styles.bodyMuted}>Wohoo! Your trip begins at </Text>
          <Text style={styles.bodyStrong}>{tripStartLine || '—'}</Text>
          <Text style={styles.bodyMuted}> with </Text>
        ...
        <Text style={styles.pickupBlock}>
          <Text style={styles.bodyMuted}>{"You're picking up the vehicle you booked at\n"}</Text>
