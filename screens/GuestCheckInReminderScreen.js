...
export default function GuestCheckInReminderScreen({ navigation, route }) {
  ...
  const hostEmail = ls.hostEmail || booking?.hostEmail || '—';
  const hostPhone = ls.hostPhone || booking?.hostPhone || '—';
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <Text style={styles.intro}>
          Here are the details for your booking. Feel free to screenshot this page so you don’t forget.
        </Text>
        ...
        <Text style={styles.hostSectionLabel}>HOST CONTACT INFO</Text>
        <Text style={styles.contactLine}>{hostEmail}</Text>
        <Text style={styles.contactLine}>{hostPhone}</Text>

        <View style={styles.hairline} />

        <Text style={styles.footerNote}>
          Please keep a direct open line of communication with the host of this vehicle to avoid any confusion.
          Confirm the license matches the guest profile.
        </Text>
      </ScrollView>
